 ...
 * run : --spring.batch.job.names=conditionStepJob
 */
@Configuration
...
public class ConditionalStepJobConfig {
    ...
    @Bean
    public Job conditionStepJob(Step conditionalStartStep, Step conditionalFailStep, Step conditionalCompletedStep, Step conditionalAllStep) {
        return jobBuilderFactory.get("conditionStepJob")
