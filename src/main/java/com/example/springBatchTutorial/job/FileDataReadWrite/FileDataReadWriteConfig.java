...
import com.example.springBatchTutorial.job.core.dto.Player;
import com.example.springBatchTutorial.job.core.dto.PlayerYears;
...
public class FileDataReadWriteConfig {
    ...
    @JobScope
    @Bean
    public Step fileReadWriteStep(ItemReader playerItemReader, ItemProcessor playersItemProcessor, ItemWriter playerItemWriter){
